...
export class Engine {
    constructor(container) {
        ...
        this.scene.fog = new THREE.Fog(0x6A8A5A, 48, 168);
    ...
    setupEnvironment() {
        ...
        const borderMat = new THREE.MeshLambertMaterial({ color: 0x1E1610 });
    ...
    buildInstancedGroundDetails() {
        ...
        const grassMat = new THREE.MeshLambertMaterial({ color: 0x5A7A42 });
        const numTufts = 90;
        ...
        const redPetalMat = new THREE.MeshLambertMaterial({ color: 0xA63D2F });
        const yellowPetalMat = new THREE.MeshLambertMaterial({ color: 0xC49A54 });
        const numFlowers = 42;
    ...
    setRealm(realmId) {
        if (this.dayNightCycle) {
            this.dayNightCycle.setRealm(realmId);
        }
    }
